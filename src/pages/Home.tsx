  ...
  return (
    <div className="w-full flex flex-col justify-center items-center space-y-2">
      ...
      <div className="w-full flex flex-col space-y-2 sm:grid sm:grid-cols-3">
        ...
        <HomeScreenCard onClickUrl="/tournaments" title="Tournament Viewer" description="Check out upcoming Lichess tournaments" imgSrc={`${process.env.PUBLIC_URL}/assets/home/tournament_viewer.png`}/>
      </div>
    </div>
  );
}
